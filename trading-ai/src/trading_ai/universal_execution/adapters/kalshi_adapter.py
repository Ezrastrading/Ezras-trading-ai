"""
Kalshi (Avenue B) — prediction-market semantics; honest capability boundaries for universal cycle.
"""
...
class KalshiAvenueAdapter(AvenueAdapterBase):
    avenue_id = "B"
    avenue_name = "kalshi"
    ...
    def capability_gaps(self) -> List[AvenueCapabilityGap]:
        return [
            AvenueCapabilityGap(
                code="not_yet_live_universal_round_trip_for_kalshi",
                detail=(
                    "Kalshi live buy/sell and settlement paths exist under trading_ai.execution.kalshi_exec and Shark, "
                    "but the universal truth-cycle orchestrator is not yet wired to them with fill confirmation + PnL persistence."
                ),
    ...
    def scan_candidates(self, ctx: AdapterContext) -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
        return [], {"note": "kalshi_scan_not_wired_to_universal_orchestrator"}
    ...
    def pretrade_validate(self, ctx: AdapterContext, candidate: Dict[str, Any]) -> Tuple[bool, Dict[str, Any]]:
        return False, {"blocking_reason": "kalshi_universal_adapter_not_wired"}
    ...
    def compute_exit_plan(self, ctx: AdapterContext, entry_meta: Dict[str, Any]) -> Tuple[Dict[str, Any], Dict[str, Any]]:
        return {"exit_reason": "prediction_market_resolution_sell", "not_wired": True}, {}
    ...
    def build_trade_record(
        ...
        *,
        ...
        return {
            ...
            "instrument_kind": "prediction_contract",
            "avenue_specific_json": {"venue": "kalshi", "wiring": "not_yet"},
        }
    ...
    def produce_execution_proof(self, ctx: AdapterContext, bundle: Dict[str, Any]) -> Dict[str, Any]:
        return {"scheduler_stable": False, "kalshi_universal_adapter": "not_wired"}
