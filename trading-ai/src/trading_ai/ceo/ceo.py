"""CEO module - main entry point for CEO functionality.

This module provides a unified interface for CEO operations, re-exporting
functionality from trading_ai.nte.ceo for backwards compatibility.
"""
