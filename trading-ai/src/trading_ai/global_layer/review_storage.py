...
REVIEW_JSON_DEFAULTS = {
    ...
    "avenue_performance.json": lambda: {
        "schema_version": "1.0",
        "generated_at": _iso(),
        "truth_version": "avenue_performance_store_v1",
        "avenues": {},
        "honesty": "Empty until execution intelligence snapshot runs.",
    },
    "capital_allocation.json": lambda: {
        "schema_version": "1.0",
        "generated_at": _iso(),
        "allocation_map": {},
        "reasoning": [],
        "risk_flags": [],
        "honesty": "Advisory allocator output.",
    },
    "strategy_state.json": lambda: {
        "schema_version": "1.0",
        "generated_at": _iso(),
        "strategies": [],
        "honesty": "Derived from strategy_scores.json.",
    },
    "global_execution_intelligence_snapshot.json": lambda: {
        "schema_version": "1.0",
        "generated_at": _iso(),
        "truth_version": "global_execution_intelligence_v1",
        "empty": True,
        "honesty": "Awaiting first snapshot.",
    },
    "goal_progress_snapshot.json": lambda: {
        "schema_version": "1.0",
        "generated_at": _iso(),
        "goal_progress": {},
        "honesty": "Goal distance from ledger + trades.",
    },
    "avenue_focus_queue.json": _default_queue_entry_template,
    "capital_allocation_queue.json": _default_queue_entry_template,
    "scaling_queue.json": _default_queue_entry_template,
    "strategy_promotion_queue.json": _default_queue_entry_template,
