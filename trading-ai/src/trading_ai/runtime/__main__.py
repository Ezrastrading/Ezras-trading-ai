...
def main() -> int:
    ...
    t.add_argument(
        "--skip-models",
        action="store_true",
        help="Research tick: stubbed reviews (default off; pass flag to skip external models)",
    )
    ...
    d.add_argument("--skip-models", action="store_true", help="Research daemon: stubbed reviews")
    ...
    ok, why, lock = try_acquire_role_lock(
        role=args.role,
        holder_id=holder,
        runtime_root=rt,
